<?php
/**
 * GraphsCommand is a console command, to check for holes in stats history
 */
class GraphsCommand extends CConsoleCommand
{
	protected $basePath;
	...
	public function run($args)
	{
		...
		if (!isset($args[0]) || $args[0] == 'help') {
			...
			echo "Yiimp graphs command\n";
			echo "Usage: yiimp graphs poolrate [algo] - find holes in hashrate graphs\n";
			echo "       yiimp graphs hashrate [algo] - find holes in user hashrate graphs\n";
			echo "       yiimp graphs balances [coin] - find holes in user balances graphs\n";
